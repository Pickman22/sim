...
def motor_velocity_controller(Ts, Pos, K = None, tau = None, R = None, L = None, 
    Kt = None, Kb = None, Kf = None, J = None):
...
class PID_Controller(object):
    ...
    def __init__(self, kp = 0., kd = 0., ki = 0., target = 0., I_MAX = None, I_MIN = None, ts = 20e-3):
        self.kp = kp
        self.kd = kd
        self.ki = ki
        self.ts = ts
...
if __name__ == '__main__':
    ...
    vel_pid = motor_velocity_controller(Ts, Pos, Kf = Kf, Kb = Kb, L = L, R = R, J = J, Kt = Kt)
    pos_pid = motor_position_controller(Ts, Pos, Kf = Kf, Kb = Kb, L = L, R = R, J = J, Kt = Kt)
    pos_pid.ts = ts
    vel_pid.ts = ts
    pos_pid.target = 1.
    vel_pid.target = 1.
    ...
    ax[1, 0].set_title('Control Action')
    ax[1, 0].legend()
    ...
    ax[1, 1].set_title('Control Action')
    ax[1, 1].legend()
    plt.show()
